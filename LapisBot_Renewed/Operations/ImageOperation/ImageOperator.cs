...
namespace LapisBot_Renewed.Operations.ImageOperation
{
    using System;
    ...
    public static class FontFamilies
    {
        ...
        public static readonly FontFamily Regular = Collection.Add(Path.Combine(Environment.CurrentDirectory, "resource/font.otf"));
        public static readonly FontFamily Light = Collection.Add(Path.Combine(Environment.CurrentDirectory, "resource/font-light.otf"));
        public static readonly FontFamily Heavy = Collection.Add(Path.Combine(Environment.CurrentDirectory, "resource/font-heavy.otf"));
        public static readonly FontFamily Emoji = Collection.Add(Path.Combine(Environment.CurrentDirectory, "resource/emoji.ttf"));
    }
    ...
    public class Image : IDisposable
    {
        ...
        public Color GetDominantColor()
        {
            ...
            for (int y = 0; y < imageSharpImage.Height; y++)
            {
                for (int x = 0; x < imageSharpImage.Width; x++)
                {
                    Rgba32 color = imageSharpImage[x, y];
